...
/************************************************
    ...
    void check_future_action(int command, const AddrHierarchy_t& addr_h) {
      switch (command) {
        case m_commands("REFab"):
          m_future_actions.push_back({command, addr_h, m_clk + m_timing_vals("nRFC1") - 1});
          break;
        case m_commands("REFsb"):
          m_future_actions.push_back({command, addr_h, m_clk + m_timing_vals("nRFCsb") - 1});
          break;
        case m_commands("RFMab"):
          m_future_actions.push_back({command, addr_h, m_clk + m_timing_vals("nRFM1") - 1});
          break;
        case m_commands("RFMsb"):
          m_future_actions.push_back({command, addr_h, m_clk + m_timing_vals("nRFMsb") - 1});
          break;
        case m_commands("DRFMab"):
          m_future_actions.push_back({command, addr_h, m_clk + m_timing_vals("nDRFMab") - 1});
          break;
        case m_commands("DRFMsb"):
          m_future_actions.push_back({command, addr_h, m_clk + m_timing_vals("nDRFMsb") - 1});
          break;
        case m_commands("RRFMsb"):
          m_future_actions.push_back({command, addr_h, m_clk + m_timing_vals("nRRFMsb") - 1});
          break;
        case m_commands("VRR"):
      ...
      switch (command) {
        case m_commands("REFab"):
          ...
          m_channels[channel_id]->update_states(m_commands("REFab_end"), addr_h, m_clk);
                    break;
        case m_commands("REFsb"):
          m_channels[channel_id]->update_powers(m_commands("REFsb_end"), addr_h, m_clk);
          m_channels[channel_id]->update_states(m_commands("REFsb_end"), addr_h, m_clk);
                    break;
        case m_commands("RFMab"):
          m_channels[channel_id]->update_powers(m_commands("RFMab_end"), addr_h, m_clk);
          m_channels[channel_id]->update_states(m_commands("RFMab_end"), addr_h, m_clk);
          break;
        case m_commands("RFMsb"):
          m_channels[channel_id]->update_powers(m_commands("RFMsb_end"), addr_h, m_clk);
          m_channels[channel_id]->update_states(m_commands("RFMsb_end"), addr_h, m_clk);
                    break;
        case m_commands("DRFMab"):
          m_channels[channel_id]->update_powers(m_commands("DRFMab_end"), addr_h, m_clk);
          m_channels[channel_id]->update_states(m_commands("DRFMab_end"), addr_h, m_clk);
          break;
        case m_commands("DRFMsb"):
          m_channels[channel_id]->update_powers(m_commands("DRFMsb_end"), addr_h, m_clk);
          m_channels[channel_id]->update_states(m_commands("DRFMsb_end"), addr_h, m_clk);
          break;
        case m_commands("RRFMsb"):
          m_channels[channel_id]->update_powers(m_commands("RRFMsb_end"), addr_h, m_clk);
          m_channels[channel_id]->update_states(m_commands("RRFMsb_end"), addr_h, m_clk);
                    break;
        case m_commands("VRR"):
  ...
  private:
    ...
    void process_rank_energy(PowerStats& rank_stats, Node* rank_node) {
      ...
      Lambdas::Power::Rank::finalize_rank<DDR5RVRR>(rank_node, 0, AddrHierarchy_t(), m_clk);
