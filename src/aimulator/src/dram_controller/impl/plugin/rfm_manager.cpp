...
public:
    ...
    void update(bool request_found, ReqBuffer::iterator& req_it) override {
        ...
        auto& req_scope = m_dram->m_command_addressing_level(req.command);
        ...
        if (m_debug) {
            ...
            std::cout << "BankGroup: " << req_it->addr_h[m_bankgroup_level] << std::endl;
        ...
        Request rfm(req.addr_h, m_rfm_req_id);
        rfm.addr_h[m_bankgroup_level] = -1;
        rfm.addr_h[m_bank_level] = -1;
